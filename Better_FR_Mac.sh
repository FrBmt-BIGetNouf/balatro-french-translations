...
#
# Script d'installation du pack de langue FR pour Balatro (version SteamDeck/mac)
...
download_balamod() {
    ...
    # Recherche du nom du fichier mac dans la dernière release (valable tant que UwUDev laisse mac dans le nom du fichier).
    balamod_mac_file=$( echo $json_latest_release | perl -nle'print $& while m{"name": "\K[^"]+-mac}g')

    # URL de téléchargement du fichier.
    mac_file_url=$( echo $json_latest_release | perl -nle'print $& while m{"browser_download_url": "\K[^"]+-mac}g')

    # Téléchargement si Balamod n'existe pas
    if [ ! -e "${ressources_folder}/${balamod_mac_file}" ]; then
        curl --create-dirs -o "${ressources_folder}/${balamod_mac_file}" -LJ "${mac_file_url}"
        chmod +x "${ressources_folder}/${balamod_mac_file}"
        # Désactive les vérifications de logiciel malveillant de macOS pour Balamod
        xattr -c "${ressources_folder}/${balamod_mac_file}"
        echo ""
...
mod_injection() {
    ...
    ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/fr.lua -o localization/fr.lua

    if [[ "$download_assets" =~ ^[Oo]$ ]]; then
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/1x/boosters.png -o resources/textures/1x/boosters.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/2x/boosters.png -o resources/textures/2x/boosters.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/1x/Tarots.png -o resources/textures/1x/Tarots.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/2x/Tarots.png -o resources/textures/2x/Tarots.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/1x/Vouchers.png -o resources/textures/1x/Vouchers.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/2x/Vouchers.png -o resources/textures/2x/Vouchers.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/1x/icons.png -o resources/textures/1x/icons.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/2x/icons.png -o resources/textures/2x/icons.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/1x/BlindChips.png -o resources/textures/1x/BlindChips.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/2x/BlindChips.png -o resources/textures/2x/BlindChips.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/1x/Jokers.png -o resources/textures/1x/Jokers.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/2x/Jokers.png -o resources/textures/2x/Jokers.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/1x/ShopSignAnimation.png -o resources/textures/1x/ShopSignAnimation.png
        ./$ressources_folder/$balamod_mac_file -x -i $ressources_folder/assets/2x/ShopSignAnimation.png -o resources/textures/2x/ShopSignAnimation.png
    fi
